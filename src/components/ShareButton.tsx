...
export const ShareButton: React.FC<ShareButtonProps> = ({ rector, className = '' }) => {
  ...
  const getShareUrl = () => {
    ...
    if (rector) {
      url.searchParams.set('rector', rector.id);
    }
  ...
  const getShareText = () => {
    if (rector) {
      return `¿Ya conoces la historia de los rectores de la USAC? 🎓\n\nDescubre el legado del ${rector.nombre} en este recorrido por los 350 años de nuestra casa de estudios. ¡Una experiencia interactiva que no te puedes perder!\n\n👇 Entra aquí:`;
    }
    return '¿Ya conoces la historia de los rectores de la USAC? 🎓\n\nDescubre el legado de nuestra casa de estudios en sus 350 años de historia. ¡Una experiencia interactiva que no te puedes perder!\n\n👇 Entra aquí:';
  };
